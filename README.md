...
* Add routing parameter `defaultRoadSpeeds`
* Add hashing of routing parameters and creation of TravelOptions to `RoutingBasedCriterionDefinition`

### 0.48.0
* Update to JDK 17
* Remove unused persistence annotations
* Swap all logging to SLf4J annotation
* Cleanup classes
...
* Remove `useStatisticTargets` parameter from `StatisticTravelOptions`
