...
public class Constants {
    ...
    public static final String KEY_MULTIGRAPH_EDGE_AGGREGATION_TYPE_MINIMUM             = "min";
    public static final String KEY_MULTIGRAPH_EDGE_AGGREGATION_TYPE_MAXIMUM             = "max";
    public static final String KEY_MULTIGRAPH_EDGE_AGGREGATION_TYPE_MEAN                = "mean";
